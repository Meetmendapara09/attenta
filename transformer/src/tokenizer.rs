...
impl BPETokenizer {
    ...
    fn default_vocab(
        ...
        let common_subwords = vec![
            "th", "he", "in", "er", "an", "on", "at", "en", "nd", "ti", "es", "or", "te", "of",
            "ed", "is", "it", "al", "ar", "st", "ing", "ion", "the", "and", "for", "are", "but",
            "not", "you", "all", "can", "had", "her", "was", "one", "our", "out", "has", "have",
            "with", "from", "they", "this", "that", "what", "will", "been", "said", "make", "like",
            "time", "just", "know", "take", "into", "year", "your", "good", "some", "them", "than",
            "then", "many", "also", "more", "about", "other", "which", "their", "there", "could",
            "would", "should", "people", "because",
        ];
    ...
    pub fn encode(&self, text: &str, max_length: usize) -> Vec<usize> {
        ...
        let mut ids: Vec<usize> = tokens.iter().map(|t| self.token_to_id(t)).collect();
    ...
    pub fn train(
        ...
        for text in texts {
            let chars: Vec<String> = text.chars().map(|c| format!("{}", c)).collect();
    ...
    pub fn train_from_file(
        ...
        Ok(Self::train(
            &texts, vocab_size, pad_id, bos_id, eos_id, unk_id,
        ))
    }
    ...
    pub fn demo_enfr() -> Self {
        ...
        let en_subwords = vec![
            ...
            "with", "from", "they", "this", "that", "what", "will", "been", "said", "make", "like",
            "time", "just", "know", "take", "into", "year", "your", "good", "some", "them", "than",
            "then", "many", "also", "about", "other", "which", "their", "there", "could", "would",
            "should", "people", "because", "little", "great", "first", "world", "water", "house",
            "place", "right", "small", "large", "high", "long", "very", "every", "after", "still",
            "where", "think", "never", "always", "thing", "man", "woman", "child", "day", "way",
            "life", "hand", "part", "eye", "woman", "men",
        ];
        ...
        let fr_subwords = vec![
            "le", "la", "les", "un", "une", "des", "du", "de", "es", "on", "en", "ai", "as", "ez",
            "er", "re", "ir", "oi", "ou", "ui", "an", "in", "on", "eu", "au", "te", "se", "me",
            "ce", "ne", "que", "lle", "ent", "ant", "ion", "men", "ment", "tion", "sion", "eur",
            "eux", "ais",
        ];
...
impl TranslationPipeline {
    ...
    pub fn translate(&self, transformer: &crate::model::Transformer, text: &str) -> String {
        let src_ids = self
            .tokenizer
            .encode_with_special(text, transformer.config().max_len);
...
mod tests {
    ...
    fn test_encode_decode_roundtrip() {
        ...
        let has_subwords = [
            "hello", "hel", "lo", "h", "e", "l", "o", "world", "wor", "ld",
        ]
        .iter()
        .any(|s| decoded.contains(s));
        assert!(
            has_subwords,
            "Decoded '{}' should contain parts of 'hello world'",
            decoded
        );
    }
